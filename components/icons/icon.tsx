...
export const Icons: { [key: string]: IconComponent } = {
  ...
  facebook: (props: xProps) => {
    const { className = "fill-current", ...rest } = props;
    return (
      <svg
        {...rest}
        xmlns="http://www.w3.org/2000/svg"
